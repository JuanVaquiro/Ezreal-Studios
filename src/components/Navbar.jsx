      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-[#2b2b2b] rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-[#2b2b2b]">
            <li>
              <Link to="/" className="block py-2 pl-3 pr-4 text-[#f8eff9] bg-[#f5b2c1] rounded md:bg-transparent
              md:hover:text-[#f5b2c1] md:p-0" aria-current="page">Inicio</Link>
            </li>
            <li>
              <Link to="/nosotros" className="block py-2 pl-3 pr-4 text-[#f8eff9] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#f5b2c1] md:p-0">Nosotros</Link>
            </li>
            <li>
              <Link to="/contact" className="block py-2 pl-3 pr-4 text-[#f8eff9] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-[#f5b2c1] md:p-0">Trabaja en el equipo</Link>
            </li>
          </ul>
        </div>
      </div>
